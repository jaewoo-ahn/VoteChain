...
function CreateVote() {
  ...
  return (
    <div>
      ...
      <div>
        <label>투표 유형:</label>
        <select onChange={(e) => setVoteType(Number(e.target.value))}>
          <option value={0}>찬반 투표</option>
          <option value={1}>선거 투표</option>
        </select>
      </div>
      <div>
        <label>후보자 목록:</label>
        <input
          type="text"
          value={elective}
          onChange={(e) => setElective(e.target.value.split(","))}
        />
      </div>
      <div>
      ...
      <div>
        ...
        <input
          type="text"
          value={regardingUsers}
          onChange={(e) => setRegardingUsers(e.target.value.split(","))}
        />
      </div>
